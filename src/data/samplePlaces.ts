...
export const INITIAL_DEMO_BUSINESSES: any[] = [
  {
    id: 'demo-biz-1',
    businessName: 'Ağdam Qarabağ Tandir & Artisanal Bakery',
    businessType: 'Retail - Bakery store',
    sector: 'Retail - Bakery store',
    city: 'Agdam (Ağdam)',
    country: 'Azerbaijan',
    address: 'Zəfər Prospekti 12, Ağdam',
    neighborhood: 'Zəfər Prospekti & Mərkəzi Ticarət Koridoru',
    latitude: 39.9918,
    longitude: 46.9292,
    storeFormat: 'Standard Retail (150 - 450 m²)',
    targetPriceTier: 'Premium & Upper-Mid ($$$)',
    projectedAnnualSalesUsd: 780000,
    estimatedCapExUsd: 110000,
    estimatedMonthlyRentUsd: 3200,
    expectedGrossMarginPct: 38,
    targetDemographicFitScore: 95,
    opportunityScore: 96,
    status: 'Ready to Deploy',
    notes: 'Flagship artisanal tandir bakery and Karabakh confectionery concept on Zəfər Prospekti. Prime pedestrian footfall and morning commuter capture.',
    createdAt: new Date().toISOString(),
    sourceSiteName: 'Zəfər Prospekti 12 Commercial Suite',
  },
  {
    id: 'demo-biz-2',
    businessName: 'Baku White City Specialty Coffee & Roastery',
    businessType: 'Specialty Cafes & Bakeries',
    sector: 'Specialty Cafes & Bakeries',
    city: 'Baku',
    country: 'Azerbaijan',
    address: 'Xəqani Rüstəmov Prospekti 24, Bakı',
    neighborhood: 'Baku White City',
    latitude: 40.3812,
    longitude: 49.8864,
    storeFormat: 'Standard Retail (150 - 450 m²)',
    targetPriceTier: 'Premium & Upper-Mid ($$$)',
    projectedAnnualSalesUsd: 920000,
    estimatedCapExUsd: 145000,
    estimatedMonthlyRentUsd: 4500,
    expectedGrossMarginPct: 42,
    targetDemographicFitScore: 96,
    opportunityScore: 94,
    status: 'Site Selected',
    notes: 'Premium third-wave roastery targeting business professionals, remote tech founders, and urban residents.',
    createdAt: new Date().toISOString(),
  },
];
